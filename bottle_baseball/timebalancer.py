...
from schedule_util import all_same, all_value, enum, shift_list, \
                ...
                if diff > 1:
                    ...
                    for commondates_dict in commondates_list:
                        ...
                        if len(today_hifield_info_list) > 1:
                            logging.info("timebalancer:rebalance:today maxfieldinfo_list entry len is %d",
                        ...
                        if today_hifield_info_list:
                            logging.info("timebalancer:refieldbalance: div=%d hifieldday=%d lofieldday=%d hifield_id=%d lofield_id=%d",
                            ...
                            logging.debug("timebalancer:refieldbalance: hifield_id info=%s", today_hifield_info)

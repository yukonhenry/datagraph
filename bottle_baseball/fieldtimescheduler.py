...
class FieldTimeScheduleGenerator:
    ...
    def generateSchedule(self, totalmatch_tuple):
        ...
        ew_list_indexer = self.timebalancer.getDivFieldEdgeWeight_list(self.divinfo_tuple,
            self.fieldinfo_list)
        ...
        for connected_div_list in self.connected_div_components:
            ...
            #reqslots_perrnd_num = sum(totalmatch_list[totalmatch_indexerGet(d)]['gameslots_perrnd_perdiv']

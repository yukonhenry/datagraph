...
#            if measure > 0:
    ...
    def generateSchedule(self, totalmatch_tuple):
        ...
        for connected_div_list in self.connected_div_components:
            ...
            requiredslots_num = sum(totalmatch_list[totalmatch_indexerGet(d)]['roundgameslots_num']
                ...
                for rrgame in rrgenobj:
                    ...
                    while True:
                        ...
                        fieldcand_list = self.findMinimumCountField(home_fieldmetrics_list,
                            away_fieldmetrics_list, rd_fieldcount_list,
                            requiredslots_num, submin)
                        ...
                        if len(fieldcand_list) > 1:
                            ...
                            if not isgame_list:
                                ...
                                index_list = [i for i,j in enumerate(isgame_list)
                                    if j['date']==min_date]
                                # reduce isgame_list to only include entries with min date

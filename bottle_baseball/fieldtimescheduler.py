...
class FieldTimeScheduleGenerator:
    ...
    def findMinimumCountField(self, homemetrics_list, awaymetrics_list, rd_fieldcount_list, reqslots_perrnd_num, hf_list, field_list, submin=0):
    ...
    def checkFieldAvailability(self, totalmatch_tuple):
        ...
        for connected_div in self.connected_div_components:
            ...
            for div_id in connected_div:
                ...
                required_slots += totalmatch['gameslots_perrnd_num']*max(totalmatch['numgames_list'])
